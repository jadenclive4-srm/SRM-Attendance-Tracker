...
import { LogOut, Trash2, Mail, Phone, MapPin, Briefcase, Users, IdCard, Camera, KeyRound, Pencil, Save, X } from "lucide-react";
  ...
  return (
    <div className="space-y-8 max-w-4xl">
                ...
                <>
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <Button variant="destructive" size="icon" aria-label="Delete account"><Trash2 className="h-4 w-4" /></Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => toast.success("Deletion request sent to admin")}>
                          Send Request
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <Detail icon={Phone} label="Phone" value={draft.phone}
          editing={editing} onChange={v => setDraft({ ...draft, phone: v })} />
