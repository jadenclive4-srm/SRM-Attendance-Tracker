...
import { AppNotification, seedAdminNotifications, seedUserNotifications, timeAgo } from "@/lib/notifications";
...
export default function NotificationsBell() {
  ...
  const [items, setItems] = useState<AppNotification[]>(() =>
    role === "admin" ? seedAdminNotifications() : seedUserNotifications()
  );
              ...
              <ul>
                {items.map(n => {
                  ...
                  return (
                    <li key={n.id}>
                      <button
                        onClick={() => { markRead(n.id); setDetail(n); setOpen(false); }}
                        className={cn(
