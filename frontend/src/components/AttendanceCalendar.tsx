    ...
    <div className="card-soft p-6">
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Click any day to view or edit (last 7 days editable).</p>
        </div>
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          style={record ? { background: bg } : undefined}
        >
      ...
      <PopoverContent className="w-72" align="center">
        <div className="space-y-3">
          ...
          {editable ? (
            ...
            !isFuture && <p className="text-[11px] text-muted-foreground pt-2 border-t border-border">
              Editing is locked after 7 days.
            </p>
          )}
        </div>
      </PopoverContent>
